...
INSERT INTO "cards" ("text_id", "name", "type", "text", "visibility", "duration") VALUES
    ...
    ('neet', 'NEET', 1, 'If you don\u2019t work, take two sips.', 'all', 0),
    ('gamers_rise_up', 'Gamers Rise Up', 1, 'Take turns naming video games that you have played. Once someone can\u2019t name a new one, they take four sips.', 'all', 0),
    ...
    ('bad_breath', 'Bad Breath', 1, 'If you haven\u2019t brushed your teeth in 24 hours, take three sips.', 'all', 0),
    ('motherland', 'Motherland', 1, 'Respect the Motherland by taking a sip of vodka. True gopniks happily drink more.', 'all', 0),
    ...
    ('companions', 'Companions', 1, 'Take a sip for every pet you\u2019ve ever owned (but no more than four sips).', 'all', 0),
    ...
    ('mix_and_mingle', 'Mix and Mingle', 1, 'Mix all players\u2019 drinks together and drink the delicious mixture.', 'all', 0),
    ('cant_be_this_cute', 'Can\u2019t Be This Cute', 1, 'If you have a little sister, take a sip. Otherwise take three sips.', 'all', 0),
    ('summertide', 'Summertide', 1, 'In summer or spring take two sips. In winter or fall take four sips.', 'all', 0),
    ('and_all_for_one', '\u2026and All for One', 1, 'During the next round, when someone must drink, everyone drinks the same amount in sympathy.', 'all', 1),
    ...
    ('insomniac', 'Insomniac', 1, 'If you didn\u2019t sleep at least seven hours last night, take two sips.', 'all', 0),
    ...
    ('charitable', 'Charitable', 1, 'If you haven\u2019t given to charity in the past year, take two sips.', 'all', 0);
...
INSERT INTO "cards" ("text_id", "name", "type", "text", "visibility", "duration") VALUES
    ...
    ('challenge', 'Challenge', 2, 'Challenge another player to arm-wrestling. The loser takes a sip from both players\u2019 drinks.', 'player', 0),
    ...
    ('kindness', 'Kindness', 2, 'Protect yourself and up to two others from an \u201Call\u201D card.', 'player', 0),
    ('no_u', 'NO U', 2, 'After someone draws an \u201Cact\u201D card, order them to carry out the card\2019s task themself.', 'player', 0),
    ...
    ('white_knight', 'White Knight', 2, 'Carry out another player\u2019s task.', 'player', 0);

-- "Permanent" cards
INSERT INTO "cards" ("text_id", "name", "type", "text", "visibility", "duration") VALUES
    ('cant_get_enough', 'Can\u2019t Get Enough', 3, 'Take a sip at the start of your every turn.', 'all', -1),
    ('cockatrice', 'Cockatrice', 3, 'You may not look anyone in the eyes. If you do, stay completely still until your next turn.', 'all', -1),
    ('deus_ex_machina', 'Deus Ex Machina', 3, 'The amounts of sips you must drink are halved! (Round up.)', 'all', -1),
    ...
    ('rhyme_and_reason', 'Rhyme and Reason', 3, 'You must speak in rhyme. Like, all the time. If your rhyme\u2019s a disappointment, two sips shall be your punishment.', 'all', -1),
    ...
    ('your_next_pose_will_be', 'Your Next Pose Will Be\u2026', 3, 'On your every turn strike a pose and keep it until your next turn.', 'all', -1);

-- "Action" cards
INSERT INTO "cards" ("text_id", "name", "type", "text", "visibility", "duration") VALUES
    ('alcoholic', 'Alcoholic', 4, 'Finish your drink. Because why not?', 'all', 0),
    ('anything_you_can_do', 'Anything You Can Do\u2026', 4, 'Pick a player. They must do something that you must then imitate. If you succeed, they take three sips. If you don\u2019t, take three sips yourself.', 'all', 0),
    ('armored', 'Armored', 4, 'For the next two rounds, you are protected from cards that you didn\u2019t draw.', 'all', 2),
    ...
    ('mimic', 'Mimic', 4, 'Imitate another player. Others rate your act on a scale of 0\u20135. The imitated player takes a sip for every five points.', 'all', 0),
    ...
    ('push_up_or_shup_up', 'Push Up, or Shut Up!', 4, 'Order a player to perform ten push-ups. If they succeed, take a sip. If they don\u2019t, they take three sips.', 'all', 0),
    ('slaver', 'Slaver', 4, 'Choose a slave. For the next three turns they have to carry out actions in your stead.', 'all', 3),
    ('special_eyes', 'Special Eyes', 4, 'Challenge another player to a staring contest. The loser takes three sips from the winner\u2019s drink.', 'all', 0),
